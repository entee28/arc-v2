    ...
    return (
        <>
            ...
            <div className='w-full h-auto mt-20 mb-12 flex flex-col items-center'>
                ...
                <p className='text-lg text-center'>Have a message for us? We've got you.</p>
                ...
                <form className='form-flex lg:w-[80%] w-[90%]' value="sentMessage" onSubmit={handleSubmit(onSubmit)}>
