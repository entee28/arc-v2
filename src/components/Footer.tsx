            ...
            <div className='w-full h-auto px-5'>
                <div className="max-w-screen-xl mx-auto">
                    <div className="flex gap-3">
                        <a href="https://www.facebook.com/ARCanimalssaigon" target='_blank' rel='noreferrer'>
                            <button className='social'><img src={facebook} alt="facebook" /></button>
                        </a>
                        <a href="https://www.instagram.com/arcpets_vietnam" target='_blank' rel='noreferrer'>
                            <button className='social'><img src={instagram} alt="facebook" /></button>
                        </a>
                    </div>
